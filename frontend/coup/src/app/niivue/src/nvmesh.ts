...
import { NiivueObject3D } from './niivue-object3D.ts' // n.b. used by connectome
import { ColorMap, LUT, cmapper } from './colortables.ts'
import { NVMeshUtilities } from './nvmesh-utilities.ts'
import { NVMeshLoaders } from './nvmesh-loaders.ts'
import { LegacyConnectome, LegacyNodes, NVConnectomeEdge, NVConnectomeNode, Point } from './types.ts'
import {
  ANNOT,
  DefaultMeshType,
  GII,
